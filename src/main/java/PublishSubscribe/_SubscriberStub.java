...
public class _SubscriberStub
	...
	implements PublishSubscribe.Subscriber
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = PublishSubscribe.SubscriberOperations.class;
	...
	public int min()
	{
		while(true)
		{
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_get_min", _opsClass);
				if( _so == null )
					continue;
				SubscriberOperations _localServant = (SubscriberOperations)_so.servant;
				int _result;
	...
	public int max()
	{
		while(true)
		{
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_get_max", _opsClass);
				if( _so == null )
					continue;
				SubscriberOperations _localServant = (SubscriberOperations)_so.servant;
				int _result;
